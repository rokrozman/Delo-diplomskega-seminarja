...
To pomeni, da je za 15m podatke učna množica za indekse 1:x in za 1h podatke 1:y. Ostali indeksi so testna množica.

```{r}
podatki_ucni = podatki[1:2342,]
```

Odstranimo še napovedni spremenljivki 
```{r}
ucna = podatki_ucni[,c(-2,-8)]
testna = podatki[2342:2744 ,][,c(-2,-8)]
```
...
To naredimo tako, da tuneGrid=data.frame(k=seq(1,200,3))
